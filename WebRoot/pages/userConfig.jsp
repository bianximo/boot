					...
					<div class="panel panel-default">
						<div class="panel-heading ">
							<h3 class="panel-title">
								<%
									if (session.getAttribute("updateIsLegal") == null) {
										out.print("请修改用户密码");
									} else {
										boolean flag = (boolean) session.getAttribute("updateIsLegal");
										if (flag)
											out.print("用户密码修改成功！请退出重新登录！");
										else
											out.print("修改失败，请重试！");
									}
								%>
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									<form role="form" action="<%=path%>/users/Users_update.action"
										method="post">
										<div class="form-group">
											<label>用户名：</label> <input name="username"
												value="${sessionScope.loginName}" class="form-control"
												type="text" placeholder="Disabled input" readonly>
										</div>
										<br>

										<div class="form-group">
											<label>原密码：</label> <input class="form-control"
												name="password">
											<p class="help-block">请输入原密码：
										</div>
										<div class="form-group">
											<label>新密码：</label> <input class="form-control"
												name="newpassword">
											<p class="help-block">请输入新密码：
										</div>
										<button type="submit" id="btn_submit" class="btn btn-primary ">修&nbsp&nbsp改</button>
